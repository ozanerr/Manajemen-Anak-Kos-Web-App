  ...
  return (
    <div className="relative min-h-[calc(100vh-4.2rem)] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center px-4">
        <div className={`text-center max-w-2xl mx-auto transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
          ...
          {/* Floating elements */}
          <div className="absolute -top-20 -left-20 w-32 h-32 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full opacity-20 animate-bounce"
            style={{ animationDelay: '0s', animationDuration: '3s' }} />
          <div className="absolute -bottom-20 -right-20 w-24 h-24 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full opacity-20 animate-bounce"
            style={{ animationDelay: '1s', animationDuration: '4s' }} />
          <div className="absolute top-1/4 -right-32 w-16 h-16 bg-gradient-to-r from-green-500 to-teal-500 rounded-full opacity-20 animate-bounce"
