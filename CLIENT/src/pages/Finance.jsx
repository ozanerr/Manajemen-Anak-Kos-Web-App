      ...
      <div className="max-w-6xl mx-auto bg-white p-4 sm:p-6 rounded-2xl shadow">
        ...
        <div className="mt-6 sm:mt-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
            ...
            <button className="hidden sm:inline-flex items-center bg-blue-600 text-white py-2 px-4 rounded-xl hover:bg-blue-700 transition text-sm cursor-pointer">
              Add Transaction
            </button>
          </div>
            ...
            <table className="min-w-full text-left text-xs sm:text-sm">
              <thead className="hidden sm:table-header-group">
                <tr className="border-b border-gray-200">
                  <th className="py-4 px-6 text-gray-600 font-medium text-left">
                    Transaction
                  </th>
                  <th className="py-4 px-6 text-gray-600 font-medium text-left">
                    Amount
              ...
              <tbody className="divide-y divide-gray-100">
                {transactions.map((tx, index) => (
                  <tr
                    ...
                    } hover:bg-blue-50 transition-colors duration-150 ease-in-out sm:table-row block mb-4 sm:mb-0 rounded-lg sm:rounded-none shadow-md sm:shadow-none overflow-hidden`}
                  >
